 ...
 * Returns the path written, or null if nothing needed to be written.
 */
export default function ensureAliasDeclarations({
  rootDir,
  anyAlias,
  anyFunctionAlias,
}: EnsureAliasDeclarationsParams): string | null {
  const aliases = [
  ...
  fs.writeFileSync(
    targetFile,
    `// Generated by ts-migrate. Global aliases used by the migrated annotations.\n${missing
