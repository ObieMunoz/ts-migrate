...
export default withStyles(() => ({
  ...
  it('complex file with multiple component and mupltiple default props', async () => {
    ...
    expect(result).toBe(readCase('multiple-components-with-multiple-defaults.expected.tsx'));
  });
  ...
  it('multiple components in one file', async () => {
    ...
    expect(result).toBe(readCase('multiple-components-in-one-file.expected.tsx'));
  });
...
`);
  ...
  it(`do not duplicate OwnProps declaration`, async () => {
    ...
    expect(result).toBe(readCase('duplicate-ownprops-declaration.expected.tsx'));
  });
