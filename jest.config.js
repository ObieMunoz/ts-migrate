...
// a real TypeScript program cost under 1s each alone and up to 10s when several
// runs compete for the same cores, which is what 30000 is sized for. It is also
// the ceiling the slowest individual tests already use, and it fails a genuine
// hang well inside ci.yml's timeout-minutes.
